        ...
        <div class="box-body">
            ...
            <form method="POST" action="{{ route('perhitungan.store') }}">
                ...
                <div class="form-group">
                    ...
                    @foreach ($penghasilanSubkriteria as $subkriteria)
                        <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                    @endforeach --}}
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="usia" name="usia" required>
                        ...
                        @foreach ($usiaSubkriteria as $subkriteria)
                            <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                        @endforeach --}}
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status_pekerjaan" name="status_pekerjaan" required>
                        ...
                        @foreach ($statusPekerjaanSubkriteria as $subkriteria)
                            <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                        @endforeach --}}
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="keluarga" name="keluarga" required>
                        ...
                        @foreach ($keluargaSubkriteria as $subkriteria)
                            <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                        @endforeach --}}
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status_rumah" name="status_rumah" required>
                        ...
                        @foreach ($statusRumahSubkriteria as $subkriteria)
                            <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                        @endforeach --}}
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="penjamin" name="penjamin" required>
                        ...
                        @foreach ($penjaminSubkriteria as $subkriteria)
                            <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                        @endforeach --}}
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="cicilan" name="cicilan" required>
                        ...
                        @foreach ($cicilanSubkriteria as $subkriteria)
                            <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                        @endforeach --}}
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="bpkb_kendaraan" name="bpkb_kendaraan" required>
                        ...
                        @foreach ($bpkbKendaraanSubkriteria as $subkriteria)
                            <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                        @endforeach --}}
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="lama_bekerja" name="lama_bekerja" required>
                        ...
                        @foreach ($lamaBekerjaSubkriteria as $subkriteria)
                            <option value="{{ $subkriteria->hasil }}">{{ $subkriteria->nama }}</option>
                        @endforeach --}}
                    </select>
                </div>
